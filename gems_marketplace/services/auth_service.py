...
from gems_marketplace.repositories.refresh_sessions import (
    add_reftoken_to_db,
    get_ref_session_from_db_by_jti,
)
from gems_marketplace.repositories.roles import get_role_by_name
...
async def revoke_all_user_ref_sessions(db_user: User, session: AsyncSession) -> None:
